...
public class 반복문4_알고리즘_가장큰수번호_문제6 {
	/*
	  [문제1] 반복문을 사용하여 랜덤숫자 1~9 을 5번출력한다. 5회
	       1) 랜덤숫자중  가장큰수와 번호를 출력  큰수 저장후 출력 변수 x 2
             (번호는 출력순서이다.)
	       2) 가장큰수가 여러개있다면 가장첫번째 번호를 출력 조건문 r == r number  
	      예) 
